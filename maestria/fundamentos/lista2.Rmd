...
Por simplicidad, nos colocamos en el espacio $(\Omega,2^\Omega,P)$. Vemos que la definicion dada equivale a decir $X = \#(S_1 \cap S_2)$, entonces $R_X = \{0,...,10\}$. Para poder determinar $f$, necesitamos calcular $P(X=x) = P(\{(S_1,S_2) \in \Omega |\#(S_1 \cap S_2) = x\})$, para cada $x \mid x \in R_X$:

\begin{align}
\#(\Omega) \times P(X = 0) &= \#\{S_1 \mid \#(S_1 \cap (N_1 \cap N_2)) = 0\} \times \#\{S_2 \mid \#(S_2 \cap (N_1 \cap N_2)) = 0,...,10\} +&\\
&\qquad \#\{S_1 \mid \#(S_1 \cap (N_1 \cap N_2)) = 1\} \times \#\{S_2 \mid \#(S_2 \cap (N_1 \cap N_2)) = 0,...,9\} +&\\
. . . +&&\\
&\qquad \#\{S_1 \mid \#(S_1 \cap (N_1 \cap N_2)) = 10\} \times \#\{S_2 \mid \#(S_2 \cap (N_1 \cap N_2)) = 0\}\\
&=1\\
\\
P(X = 9)\#(\Omega) &= \binom{10}{10} \times \binom{10}{10}\\
&=1\\
\\
