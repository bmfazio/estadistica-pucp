...
**Resolución:** Usamos la fórmula de Hájek para estimar intervalos de confianza en una población finita, aplicada a una proporción:
...
**Resolución:**  Bajo los supuestos del ejercicio anterior, generamos una muestra de la población considerando las variables requeridas.
